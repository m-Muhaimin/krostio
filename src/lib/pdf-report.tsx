      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.seal}>
            <Text style={styles.sealText}>KROSTIO</Text>
          </View>
        ...
        <View style={styles.verificationBox}>
          ...
          <Text style={styles.verificationText}>
            This report was generated by Krostio on {reportDate}. Income data displayed in this report was sourced directly from
            the gig platform(s) via authenticated API connections authorized by the worker. Data is not self-reported.
            {'\n\n'}
            Krostio is an income verification tool, not a credit reporting agency. This report reflects earnings data as of the report
            date and should be verified for currency by the receiving institution. Krostio makes no representation regarding
        ...
        <View style={{ ...styles.verificationBox, marginTop: 8 }}>
          ...
          <Text style={{ fontSize: 7, color: '#71717a', lineHeight: 1.4 }}>
            ...
            {'\n'}
            Krostio Score (300–850) is an income verification metric, not a consumer credit report. It is not a substitute for a FICO score and shall not be used as the sole basis for adverse action.
            {'\n'}
        ...
        <Text style={styles.footer}>
          Krostio — Income Verification Report — Report ID: {reportId} — Page 1 of 1
        </Text>
      </Page>
    </Document>
  )
