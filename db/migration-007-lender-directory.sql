...
-- =========================================================================
-- We insert profile stubs first (role='lender') then lender_profiles using the same uuids.
-- Stubs use a placeholder email pattern so they don't collide with real auth users.

INSERT INTO profiles (id, role, full_name, email, onboarding_completed)
VALUES
  ('11111111-1111-1111-1111-111111111101', 'lender', 'Kashable', 'seed+kashable@krost.example', true),
  ('11111111-1111-1111-1111-111111111102', 'lender', 'Oportun', 'seed+oportun@krost.example', true),
  ('11111111-1111-1111-1111-111111111103', 'lender', 'LendingClub', 'seed+lendingclub@krost.example', true),
  ('11111111-1111-1111-1111-111111111104', 'lender', 'Carvana', 'seed+carvana@krost.example', true),
  ('11111111-1111-1111-1111-111111111105', 'lender', 'Rocket Mortgage', 'seed+rocket@krost.example', true),
  ('11111111-1111-1111-1111-111111111106', 'lender', 'Fundera', 'seed+fundera@krost.example', true)
